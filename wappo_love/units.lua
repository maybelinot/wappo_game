...
get_object[2] = function ()
    ...
    enemy_red.animations.idle = enemy_red.animations.kill
...
get_object[4] = function ()
    ...
    enemy_blue.animations.idle = enemy_blue.animations.kill
